...
<div class="main-body">
    <div class="mainwrapper">
        <div class="result-panel">
            ...
            <div class="result-wrapper">
                ...
                <div class="seats-charts">
                    <div class="partydoughnutchart">
                        ...
                        ?>
                        <div class="result-seats-info"> <?php echo $totalseats ?> Seats <?php echo $majority ?> For
                            Majority</div>
                        <?php
                        }
                        ?>
            ...
            <div class="tablebox">
                <table id="mytable">
                    <caption style="font-size: 2rem;font-weight: 500; margin-bottom:10px">Candidates Who Won Election
                    </caption>
                    <thead>
                        <tr>
                            <th>Constituency</th>
